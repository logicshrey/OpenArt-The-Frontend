  ...
  const MobileNavMenu = () => (
    <div className={`fixed inset-0 z-50 bg-black ${isMobileMenuOpen ? 'block' : 'hidden'}`}>
      ...
      <div className="flex flex-col items-center space-y-6 mt-12">
        ...
        <a href="/createannouncement" className="text-xl" onClick={() => setIsMobileMenuOpen(false)}>Create Announcement</a>
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <div className="text-center py-20 px-4">
        <h1 className="text-4xl md:text-6xl font-bold mb-6">Artverse</h1>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center gap-2 flex-wrap">
                        <span className="font-semibold text-sm md:text-base">{announcement.owner?.fullName}</span>
                        <span className="text-gray-500 text-xs md:text-sm">@{announcement.owner?.username}</span>
                        <span className="text-gray-500 text-xs md:text-sm">·</span>
                        <span className="text-gray-500 text-xs md:text-sm">{formatDate(announcement.createdAt)}</span>
                      </div>
                      <div className="mt-2">
                        <span className="px-2 py-1 bg-gray-800 rounded-full text-xs md:text-sm">{announcement.category}</span>
                      </div>
                      <h3 className="text-lg md:text-xl font-semibold mt-2">{announcement.title}</h3>
                      <p className="mt-2 text-sm md:text-base text-gray-300 whitespace-pre-wrap">{announcement.description}</p>
                      {announcement.image && (
                        <img 
                      ...
                      <div className="flex items-center gap-4 md:gap-6 mt-4 text-gray-400">
                        <button 
                        ...
                        >
                          <Heart size={16} md:size={20} fill={announcement.isLiked ? "currentColor" : "none"} />
                          <span className="text-xs md:text-base">{announcement.likesCount}</span>
                        </button>
                        ...
                        >
                          <MessageCircle size={16} md:size={20} />
                          <span className="text-xs md:text-base">{announcement.commentsCount}</span>
                        </button>
                        ...
                        >
                          <Bookmark size={16} md:size={20} fill={announcement.isSaved ? "currentColor" : "none"} />
                        ...
                        <div className="mt-4 space-y-4">
                          ...
                          >
                            ...
                            <button
                              ...
                              className="px-4 py-2 bg-gray-800 rounded-lg hover:bg-gray-700 transition-colors disabled:opacity-50 text-sm"
                            >
                              Post
                            </button>
                          </form>
