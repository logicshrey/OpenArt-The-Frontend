// Part 1: Imports through fetchComments function
...
//   const fetchComments = async () => {
//     try {
//       const response = await fetch(`http://localhost:8000/openart/api/comments/${artworkId}`, {
//         credentials: 'include'
//       });
...
//   const handleLike = async () => {
//     try {
//       const response = await fetch(`http://localhost:8000/openart/api/artworks/${artworkId}/like`, {
//         method: 'POST',
//         credentials: 'include'
//       });
...
//   const handleSave = async () => {
//     try {
//       const response = await fetch(`http://localhost:8000/openart/api/artworks/${artworkId}/save`, {
//         method: 'POST',
//         credentials: 'include'
//       });
...
//   const handleDeleteComment = async (commentId) => {
//     try {
//       const response = await fetch(`http://localhost:8000/openart/api/comments/${commentId}`, {
//         method: 'DELETE',
//         credentials: 'include'
//       });
